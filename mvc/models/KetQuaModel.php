<?php
    class KetQuaModel extends Database
    {
        ...
        function loadPoint($MaSV,$NamHoc,$HocKy)
        {
        ...
        function loadHocKyHPChuaTichLuy($MaKhoa,$maTK)
        {
            ...
            not in (select MaHP from lichsudangkyhocphan where MaTK = '".$maTK."') 
        ...
        function loadHPChuaTichLuy($MaKhoa,$maTK,$maHK,$maNH)
        {
            ...
            (select ls.MaHP from lichsudangkyhocphan as ls where ls.MaTK = '".$maTK."') order BY 
